...
// Fetch subjects for the current instructor - subjects should be assigned to instructor by the admin, hence each subject has an instructor_id in its table
...
<body>
    ...
    <!-- Display created/exisiting questions here -->
        ...
        <table border="1">
            ...
            <?php foreach ($quiz_questions as $question): ?>
                <tr>
                    ...
                    <td><a href="edit_quiz.php?id=<?php echo $question['id']; ?>">Edit</a></td>
                </tr>
            <?php endforeach; ?>
        </table>
    <?php else: ?>
