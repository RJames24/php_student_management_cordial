...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("SELECT instructor_id, password FROM instructors WHERE username = ? AND password = ?");
    if (!$stmt) {
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-2xl overflow-hidden max-w-3xl w-full flex flex-row-reverse">
        ...
        <div class=" md:block w-1/3 bg-primary relative">
            ...
            <div class="relative left-14 mt-20">
                <button class="bg-white font-bold text-primary py-2 px-4 rounded-full w-1/2 hover:bg-gray-100 transition duration-300"><a href="signup.php">Sign Up</a></button>
            </div>  
